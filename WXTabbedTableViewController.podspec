#
#  Be sure to run `pod spec lint WXTabbedTableViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "buptwsg" => "buptwsg@yeah.net" }
  ...
  s.source_files  = "TabbedTableViewController", "TabbedTableViewController/*.{h,m}"
